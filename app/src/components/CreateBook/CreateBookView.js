        ...
        return (
            <div className="createBook--container">
                <div>
                    <label>Title:</label>
                    <input 
                        className={`${required.title && 'create--required'}`} 
                ...
                <div>
                    <label>Author:</label>
                    <input 
                        className={`${required.author && 'create--required'}`} 
                ...
                <div>
                    ...
                    <input 
                        className={`${required.publisher && 'create--required'}`} 
                ...
                <div>
                    ...
                    <input 
                        className={`${required.released && 'create--required'}`} 
                        onChange={this.props.onReleasedChange} 
                        value={book.released} 
                        type="text" />
                </div>
                <hr />
                <div>
                    <label>Genre: <span className="small--text">seperate with commas</span></label>
                    <input 
                ...
                <div>
                    ...
                    <input 
                        type="checkbox" 
                        onChange={this.props.onBorrowedChange} 
                        value={book.borrowed.from} 
                        className="toggle toggle--borrowed" 
                        id="borrowed" />
                ...
                <div>
                    ...
                    <input 
                        type="checkbox" 
                        onChange={this.props.onLoanedChange} 
                        value={book.loaned.to} 
                        className="toggle toggle--loaned" 
                        id="loaned" />
